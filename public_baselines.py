...
print "Total points in training data: ", len(training_set)
to_keep = random.sample(range(len(training_set)), k=int(round(len(training_set)*0.05)))
training_set_reduced = [training_set[i] for i in to_keep]
print "Total points in reduced training data: ", len(training_set_reduced)
...
temp_diff_test = []
comm_auth_test = []
print "Total points in testing data: ", len(testing_set)
counter = 0
